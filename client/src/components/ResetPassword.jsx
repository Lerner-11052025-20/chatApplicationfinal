...
function ResetPassword() {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        axios.post(`http://localhost:3334/api/resetpassword/${token}`, { password })
            .then(() => {
                setSuccess(true);
            ...
            >
                ...
                <div className="glass p-8 lg:p-10 rounded-[2.5rem] border border-white/5 relative overflow-hidden group">
                    ...
                    <div className="text-center mb-10">
                        ...
                        >
                            <KeyRound size={28} className="text-white fill-white/20" />
                        </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold text-gray-400 ml-4">New Password</label>
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full pl-12 pr-12 py-3.5 bg-white/5 border border-white/5 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white/10 transition-all text-sm text-white placeholder:text-gray-700"
                                    required
                                />
                                <button
                                    type="button"
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold text-gray-400 ml-4">Confirm New Password</label>
                            <div className="relative group/input">
                                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within/input:text-blue-400 transition-colors">
                                    <Lock size={18} />
                                </div>
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/5 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white/10 transition-all text-sm text-white placeholder:text-gray-700"
                                    required
                                />
                            </div>
                        </div>
