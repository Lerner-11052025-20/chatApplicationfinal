...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:3334/api/login', { email, password })
            .then(res => {
        ...
        <div className="min-h-screen bg-dark-bg flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between items-center px-4">
                                ...
                                <Link to="/forgotpass" className="text-[10px] font-bold text-blue-400 hover:text-blue-300 transition-colors uppercase tracking-wider">
                                    Forgot?
                                </Link>
                            </div>
                            <div className="relative group/input">
                ...
                <p className="text-center text-gray-600 text-xs mt-8 tracking-widest uppercase font-bold">
                    ChatWave · Secured by Cryptography
                </p>
            </motion.div>
        </div>
    );
